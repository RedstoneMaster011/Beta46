...
package net.mcreator.beta.world.inventory;
...
public class InvintoryFakeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InvintoryFakeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
