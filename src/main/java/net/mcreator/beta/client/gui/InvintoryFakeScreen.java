package net.mcreator.beta.client.gui;
...
public class InvintoryFakeScreen extends AbstractContainerScreen<InvintoryFakeMenu> {
	private final static HashMap<String, Object> guistate = InvintoryFakeMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public InvintoryFakeScreen(InvintoryFakeMenu container, Inventory inventory, Component text) {
